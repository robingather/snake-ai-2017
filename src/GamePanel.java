...
public class GamePanel extends JPanel implements Runnable, KeyListener {
	...
	public void keyReleased(KeyEvent press) {
		...
		if (key == KeyEvent.VK_BACK_SPACE) { //ACTIVATE UBERSNAKE SEPHIRAN, DESTROYER OF RABBITS
			weights[0] = -3.23;weights[1] = 4.84;weights[2] = -4.72;weights[3] = 0.04;
			weights[4] = 1.58;weights[5] = -3.42;weights[6] = -0.20;weights[7] = -1.32;
			weights[8] = 2.54;weights[9] = 1.54;weights[10] = -1.04;weights[11] = -2.49;
			weights[12] = 1.24;weights[13] = 1.54;weights[14] = 1.33;weights[15] = 2.31;
			weights[16] = 4.65;weights[17] = -1.79;weights[18] = -3.95;weights[19] = -1.94;
			weights[20] = 2.94;weights[21] = -4.77;weights[22] = 0.62;weights[23] = 0.29;
			weights[24] = 4.60;weights[25] = 1.10;weights[26] = 2.75;weights[27] = -0.36;
			weights[28] = -3.06;weights[29] = -4.41;weights[30] = -2.46;weights[31] = -1.78;
			weights[32] = 0.72;weights[33] = -4.50;weights[34] = 0.79;weights[35] = -4.44;
			weights[36] = 0.54;weights[37] = -3.01;weights[38] = 4.16;weights[39] = -2.64;
			weights[40] = 1.54;weights[41] = -1.97;weights[42] = -3.18;weights[43] = -0.25;
			weights[44] = -0.24;
		}
	...
	private void update() {
		...
		//Point system, could do points = s_fitness 
		...
		//Speed increases with level (not essential but adds an extra level of difficulty for the player)
			Entity s = new Entity(SIZE);
	...
	public void render(Graphics2D g2d){
		...
		if (debug) {
			...
			g2d.setColor(Color.WHITE);
			g2d.drawString("Last snake = " + last_length + ", with fitness = " + last_fitness, 4, HEIGHT-24);
			g2d.drawString("Longest Snake = " + best_length + ", with fitness = " + best_fitness, 4, HEIGHT-8);
			
		} else {
			
			g2d.setColor(Color.WHITE);
			g2d.drawString("Gen= " + generation + "  Id= " + s_idd, 4, 14);
			g2d.drawString("Last snake = " + last_length, 4, HEIGHT-24);
			g2d.drawString("Longest Snake = " + best_length, 4, HEIGHT-8);
